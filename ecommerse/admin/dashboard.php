...
ob_start(); // Output Buffering Start // وهنا بنحط هاد الفنكشن قبل كل شي عشان ميطلعش بعض الاخطاء الخاصة بالسيت هيدر
session_start();
                 ...
                 <div class="container  text-center">
                         ...
                         <div class="row">
                             ...
                             <div class="stat st-item">
                                 Total Items
                                 <span><a href="items.php"><?php echo getcount('ItemID' , 'items') ?></a></span>
                                 </div>
                             </div>
                             <div class="col-md-3">
